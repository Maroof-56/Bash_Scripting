...
bucket_name="maroof-bucket"
lambda_func_name="s3-lambda-function"
role_name="s3-lambda-sns"
email_address="maroofahmed002@gmail.com"
...
aws sns publish \
  ...
  --message "Hello from maroof, message: whenever new object will upload you will get notification."
